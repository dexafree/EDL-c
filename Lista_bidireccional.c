/*
 * ARCHIVO DE IMPLEMENTACIÓN DE FUNCIONES DE UNA LISTA DINÁMICA EN C
 * 
...
Lista LISTA_create (){
	...
	if (l.first == NULL) {
		...
		l.first->e = ELEMENT_indefinit(); // Asignamos un elemento indefinido al primer elemento de la lista
		l.first->next = NULL; // Apuntamos el campo next del primer elemento de la lista a NULL (ya que no existe todavía)
